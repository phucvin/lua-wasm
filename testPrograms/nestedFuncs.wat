...
(data (i32.const 24) "Entering f")
(data (i32.const 40) "Entering g")
(data (i32.const 56) "Entering h")
(data (i32.const 72) "Exiting h")
(data (i32.const 88) "Calling h")
(data (i32.const 104) "Exiting g")
(data (i32.const 120) "Calling g")
(data (i32.const 136) "Exiting f")
(data (i32.const 152) "Calling f")
(data (i32.const 168) "Done!")

    (global $HP (export "HP") (mut i32) (i32.const 176))
    (global $FP (export "FP") (mut i32) (i32.const 176))
    ...
    (table 7 funcref)
    (elem (i32.const 0) $f0 $f1 $f2 $f3 $f4 $f5 $f6 )
(func $f0 (export "main")
 ...
 (i32.store (i32.const 52) (i32.const 10))
 (i32.store (i32.const 68) (i32.const 9))
 (i32.store (i32.const 84) (i32.const 9))
 (i32.store (i32.const 100) (i32.const 9))
 (i32.store (i32.const 116) (i32.const 9))
 (i32.store (i32.const 132) (i32.const 9))
 (i32.store (i32.const 148) (i32.const 9))
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 148))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
...
(func $f4
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 116))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 132))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
...
(func $f5
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 84))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
