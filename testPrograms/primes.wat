...
(data (i32.const 24) "checkPrime")
(data (i32.const 40) "I found")
(data (i32.const 52) "primes. They were: ")
(data (i32.const 76) "Prime number")
(data (i32.const 96) "is")

    (global $HP (export "HP") (mut i32) (i32.const 100))
    (global $FP (export "FP") (mut i32) (i32.const 100))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 48) (i32.const 19))
 (i32.store (i32.const 72) (i32.const 12))
 ...
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 14))
 (global.set $HP (i32.add (global.get $HP) (i32.const 124)))
 ...
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1000))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (memory.copy
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 48))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
 ...
 (block $whileLoop2 (loop
   ...
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 72))
   (i32.store (global.get $SP) (i32.const 4))
   (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
   (i32.store (global.get $SP) (i32.const 1))
...
(func $f4
 (call $alloc (i32.const 52))
 (i32.store (i32.sub (global.get $HP) (i32.const 52)) (i32.load (i32.add (i32.const 4) (i32.load
     (i32.add
      (global.get $SP)
      (i32.add
       (i32.mul
 ...
 (i32.store
  (i32.add (i32.const 4) (i32.sub (global.get $HP) (i32.const 52)))
  (global.get $FP)
  )
 (i32.store
  (i32.add (i32.const 8) (i32.sub (global.get $HP) (i32.const 52)))
  (i32.const 5)
  )
 (global.set $FP (i32.sub (global.get $HP) (i32.const 52)))
 (i32.lt_s (i32.const 0) (i32.sub (i32.load (i32.add (i32.const 12) (global.get $SP))) (i32.const 1)))
 (if (then
   (memory.copy
    (i32.add
