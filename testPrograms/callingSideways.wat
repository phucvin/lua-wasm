...
(data (i32.const 24) "in g, outer a and b")
(data (i32.const 48) "inner a and b")
(data (i32.const 68) "f, outer a and b")
(data (i32.const 92) "back to f, inner a and b")
(data (i32.const 124) "back to outside scope")

    (global $HP (export "HP") (mut i32) (i32.const 148))
    (global $FP (export "FP") (mut i32) (i32.const 148))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 44) (i32.const 13))
 (i32.store (i32.const 64) (i32.const 16))
 (i32.store (i32.const 88) (i32.const 24))
 (i32.store (i32.const 120) (i32.const 21))
 (i32.store (global.get $FP) (i32.const -1))
 (i32.store (i32.add (i32.const 4) (global.get $FP)) (i32.const -1))
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 6))
 (global.set $HP (i32.add (global.get $HP) (i32.const 60)))
...
(func $f4
 ...
 (global.set $FP (i32.load (i32.add (global.get $FP) (i32.const 4))))
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 300))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (memory.copy
  (i32.add (global.get $FP) (i32.const 12))
 ...
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 400))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (memory.copy
  (i32.add (global.get $FP) (i32.const 20))
...
(func $f5
 ...
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 200))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (memory.copy
  (i32.add (global.get $FP) (i32.const 20))
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 88))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
