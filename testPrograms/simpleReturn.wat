...
(data (i32.const 24) "Too low! Guess higher")
(data (i32.const 52) "Too high! Guess lower")
(data (i32.const 80) "You guessed it!")

    (global $HP (export "HP") (mut i32) (i32.const 96))
    (global $FP (export "FP") (mut i32) (i32.const 96))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 20) (i32.const 21))
 (i32.store (i32.const 48) (i32.const 21))
 (i32.store (i32.const 76) (i32.const 15))
...
(func $f4
 ...
 (if (then
   ...
   (global.set $temp (i32.sub (global.get $HP) (i32.const 4)))
   (i32.store (i32.sub (global.get $HP) (i32.const 4)) (i32.const 0))
   (global.set $SP (i32.add (global.get $SP) (i32.const 0)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (global.get $temp))
   (i32.store (global.get $SP) (i32.const 7))
