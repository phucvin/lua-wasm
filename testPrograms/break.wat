...
(data (i32.const 24) "5, break from while")
(data (i32.const 48) "x is")
(data (i32.const 60) "incrementing")
(data (i32.const 80) "repeating loop")
(data (i32.const 100) "Inbetween while and for")
(data (i32.const 128) "6, break from numeric for")
(data (i32.const 160) "Done, x should be 5 (since the for loop x is local)")
(data (i32.const 216) "table")
(data (i32.const 228) "A")
(data (i32.const 236) "B")
(data (i32.const 244) "C")
(data (i32.const 252) "D")
(data (i32.const 260) "E")

    (global $HP (export "HP") (mut i32) (i32.const 264))
    (global $FP (export "FP") (mut i32) (i32.const 264))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 56) (i32.const 12))
 (i32.store (i32.const 76) (i32.const 14))
 (i32.store (i32.const 96) (i32.const 23))
 (i32.store (i32.const 124) (i32.const 25))
 (i32.store (i32.const 156) (i32.const 51))
 (i32.store (i32.const 212) (i32.const 5))
 (i32.store (i32.const 224) (i32.const 1))
 (i32.store (i32.const 232) (i32.const 1))
 (i32.store (i32.const 240) (i32.const 1))
 (i32.store (i32.const 248) (i32.const 1))
 ...
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 12))
 (global.set $HP (i32.add (global.get $HP) (i32.const 108)))
 ...
 (block $whileLoop0 (loop
   ...
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 56))
   (i32.store (global.get $SP) (i32.const 4))
   (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
   (i32.store (global.get $SP) (i32.const 1))
   ...
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 76))
   (i32.store (global.get $SP) (i32.const 4))
   (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
   (i32.store (global.get $SP) (i32.const 1))
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 96))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
 ...
 (block $whileLoop1 (loop
   ...
   (if (then
     ...
     (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 124))
     (i32.store (global.get $SP) (i32.const 4))
     (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
     (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
     (i32.store (global.get $SP) (i32.const 1))
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 156))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
 ...
 i32.store
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 212))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 16)))
 (i32.store
 ...
 (i32.store (global.get $SP) (i32.const 6))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 224))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 232))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 240))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 248))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 256))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (call $hashInsert (i32.add (global.get $SP) (i32.const 56)) (i32.add (global.get $SP) (i32.const 8)) (i32.add (global.get $SP) (i32.const 48)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 2))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (call $hashInsert (i32.add (global.get $SP) (i32.const 56)) (i32.add (global.get $SP) (i32.const 8)) (i32.add (global.get $SP) (i32.const 40)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 3))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (call $hashInsert (i32.add (global.get $SP) (i32.const 56)) (i32.add (global.get $SP) (i32.const 8)) (i32.add (global.get $SP) (i32.const 32)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 4))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (call $hashInsert (i32.add (global.get $SP) (i32.const 56)) (i32.add (global.get $SP) (i32.const 8)) (i32.add (global.get $SP) (i32.const 24)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 5))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (call $hashInsert (i32.add (global.get $SP) (i32.const 56)) (i32.add (global.get $SP) (i32.const 8)) (i32.add (global.get $SP) (i32.const 16)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 40)))
 (memory.copy
  (i32.load
   (i32.add
    (global.get $SP)
