...
(func $f0 (export "main")
 ...
 i32.store
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 77))
...
(func $f4
 (call $alloc (i32.const 60))
 (i32.store (i32.sub (global.get $HP) (i32.const 60)) (i32.load (i32.add (i32.const 4) (i32.load
     (i32.add
      (global.get $SP)
      (i32.add
       (i32.mul
 ...
 (i32.store
  (i32.add (i32.const 4) (i32.sub (global.get $HP) (i32.const 60)))
  (global.get $FP)
  )
 (i32.store
  (i32.add (i32.const 8) (i32.sub (global.get $HP) (i32.const 60)))
  (i32.const 6)
  )
 (global.set $FP (i32.sub (global.get $HP) (i32.const 60)))
 (i32.lt_s (i32.const 0) (i32.sub (i32.load (i32.add (i32.const 12) (global.get $SP))) (i32.const 1)))
 (if (then
   (memory.copy
    (i32.add
