...
(data (i32.const 24) "F ran!")
(data (i32.const 36) "Hello")
(data (i32.const 48) "World")
(data (i32.const 60) "Test")
(data (i32.const 72) "Ing")
(data (i32.const 80) "This should print")
(data (i32.const 104) "This shouldn't print")
(data (i32.const 132) "0 is true")
(data (i32.const 148) "1 is also true")
(data (i32.const 168) "0 is true, so this doesn't print")
(data (i32.const 208) "1 is true so this doesn't print")
(data (i32.const 244) "")
(data (i32.const 252) "the empty string is true, so this prints")
(data (i32.const 300) "shouldBe1")
(data (i32.const 316) "shouldBe2")

    (global $HP (export "HP") (mut i32) (i32.const 328))
    (global $FP (export "FP") (mut i32) (i32.const 328))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 44) (i32.const 5))
 (i32.store (i32.const 56) (i32.const 4))
 (i32.store (i32.const 68) (i32.const 3))
 (i32.store (i32.const 76) (i32.const 17))
 (i32.store (i32.const 100) (i32.const 20))
 (i32.store (i32.const 128) (i32.const 9))
 (i32.store (i32.const 144) (i32.const 14))
 (i32.store (i32.const 164) (i32.const 32))
 (i32.store (i32.const 204) (i32.const 31))
 (i32.store (i32.const 240) (i32.const 0))
 (i32.store (i32.const 248) (i32.const 40))
 (i32.store (i32.const 296) (i32.const 9))
 (i32.store (i32.const 312) (i32.const 9))
 (i32.store (global.get $FP) (i32.const -1))
 (i32.store (i32.add (i32.const 4) (global.get $FP)) (i32.const -1))
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 3))
 (global.set $HP (i32.add (global.get $HP) (i32.const 36)))
 ...
 (block
  ...
  (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
  (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 32))
  (i32.store (global.get $SP) (i32.const 4))
  (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
  )
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 ...
 (block
  ...
  (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
  (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 164))
  (i32.store (global.get $SP) (i32.const 4))
  (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
  )
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 ...
 (block
  ...
  (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
  (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 204))
  (i32.store (global.get $SP) (i32.const 4))
  (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
  )
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 ...
 i32.store
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 296))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 16)))
 (i32.store
 ...
 i32.store
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 312))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 16)))
 (i32.store
