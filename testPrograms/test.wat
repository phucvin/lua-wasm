...
(data (i32.const 36) "Why")
(data (i32.const 44) "Hello World")

    (global $HP (export "HP") (mut i32) (i32.const 56))
    (global $FP (export "FP") (mut i32) (i32.const 56))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 40) (i32.const 11))
