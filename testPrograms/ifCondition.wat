...
(data (i32.const 24) "Var 1 and var 2")
(data (i32.const 44) "Var 1 and not var 2")
(data (i32.const 68) "Neither")

    (global $HP (export "HP") (mut i32) (i32.const 76))
    (global $FP (export "FP") (mut i32) (i32.const 76))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 40) (i32.const 19))
 ...
 (if (then
   ...
   (block
    ...
    (i32.store (i32.add (global.get $SP) (i32.const 8)) (i32.const 3))
    )
   (global.set $SP (i32.add (global.get $SP) (i32.const 8)))
   (i32.and
    (i32.ne
