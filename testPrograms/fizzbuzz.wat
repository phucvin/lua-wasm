...
(data (i32.const 44) "Buzz")

    (global $HP (export "HP") (mut i32) (i32.const 52))
    (global $FP (export "FP") (mut i32) (i32.const 52))
 ...
 (block $whileLoop0 (loop
   ...
   (if (then
     ...
     (if (then
       ...
       i32.store
       (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
       (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 40))
       (i32.store (global.get $SP) (i32.const 4))
       (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
       (global.set $SP (i32.add (global.get $SP) (i32.const 16)))
       (call $alloc (i32.add (i32.add
