...
(data (i32.const 24) "I am f")
(data (i32.const 36) "My a is")
(data (i32.const 48) "I multiplied it by 2, see")
(data (i32.const 80) "I am the main function")
(data (i32.const 108) "Calling f")
(data (i32.const 124) "Back to main, my a is still 105")
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 44) (i32.const 25))
 (i32.store (i32.const 76) (i32.const 22))
 (i32.store (i32.const 104) (i32.const 9))
 (i32.store (i32.const 120) (i32.const 31))
 (i32.store (global.get $FP) (i32.const -1))
 (i32.store (i32.add (i32.const 4) (global.get $FP)) (i32.const -1))
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 4))
 (global.set $HP (i32.add (global.get $HP) (i32.const 44)))
 ...
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 104))
 (i32.store (global.get $SP) (i32.const 4))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
 (i32.store (global.get $SP) (i32.const 1))
