...
(data (i32.const 24) "Test 1 -----")
(data (i32.const 44) "Test 2 ------")
(data (i32.const 64) "Test 3 ------")
(data (i32.const 84) "Test 4 ------")
(data (i32.const 104) "Test 5 ------")
(data (i32.const 124) "Test 6 ------")

    (global $HP (export "HP") (mut i32) (i32.const 140))
    (global $FP (export "FP") (mut i32) (i32.const 140))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 40) (i32.const 13))
 (i32.store (i32.const 60) (i32.const 13))
 (i32.store (i32.const 80) (i32.const 13))
 (i32.store (i32.const 100) (i32.const 13))
 (i32.store (i32.const 120) (i32.const 13))
...
(func $f4
 ...
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 101))
 (i32.store (global.get $SP) (i32.const 1))
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (call $alloc (i32.const 20))
 (global.set $temp (i32.sub (global.get $HP) (i32.const 20)))
