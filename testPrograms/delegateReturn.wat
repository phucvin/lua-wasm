...
(func $f0 (export "main")
 ...
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 8))
 (global.set $HP (i32.add (global.get $HP) (i32.const 76)))
...
(func $f5
 ...
 (call $alloc (i32.add
   (i32.const 12)
   (i32.mul (i32.const 8) (i32.load (i32.load
      (i32.add
       (global.get $SP)
       (i32.const 12)
       )
 ...
 (global.set $temp (i32.sub (global.get $HP) (i32.add
    (i32.const 12)
    (i32.mul (i32.const 8) (i32.load (i32.load
       (i32.add
        (global.get $SP)
 ...
 (i32.store (i32.sub (global.get $HP) (i32.add
    (i32.const 12)
    (i32.mul (i32.const 8) (i32.load (i32.load
       (i32.add
        (global.get $SP)
 ...
 (memory.copy
  (i32.add (i32.const 4) (i32.sub (global.get $HP) (i32.add
     (i32.const 12)
     (i32.mul (i32.const 8) (i32.load (i32.load
        (i32.add
         (global.get $SP)
 ...
 (memory.copy
  (i32.add (i32.const 12) (i32.sub (global.get $HP) (i32.add
     (i32.const 12)
     (i32.mul (i32.const 8) (i32.load (i32.load
        (i32.add
         (global.get $SP)
