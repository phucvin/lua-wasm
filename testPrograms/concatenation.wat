...
(data (i32.const 24) "a")
(data (i32.const 32) "b")
(data (i32.const 40) "ab")
(data (i32.const 48) "aaaaa")
(data (i32.const 60) "")
(data (i32.const 68) "iteration")
(data (i32.const 84) "loop is")
(data (i32.const 96) "done")

    (global $HP (export "HP") (mut i32) (i32.const 104))
    (global $FP (export "FP") (mut i32) (i32.const 104))
...
(func $f0 (export "main")
 ...
 (i32.store (i32.const 64) (i32.const 9))
 (i32.store (i32.const 80) (i32.const 7))
 (i32.store (i32.const 92) (i32.const 4))
 (i32.store (global.get $FP) (i32.const -1))
 (i32.store (i32.add (i32.const 4) (global.get $FP)) (i32.const -1))
 (i32.store (i32.add (i32.const 8) (global.get $FP)) (i32.const 11))
 (global.set $HP (i32.add (global.get $HP) (i32.const 100)))
 ...
 (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
 (global.set $SP (i32.add (global.get $SP) (i32.const 16)))
 (call $alloc (i32.add (i32.add
    (i32.const 4)
    (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
    ) (i32.sub (i32.const 4) (i32.rem_s (i32.add
      (i32.const 4)
      (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
      ) (i32.const 4)))))
 (i32.store (i32.sub (global.get $HP) (i32.add (i32.add
     (i32.const 4)
     (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
     ) (i32.sub (i32.const 4) (i32.rem_s (i32.add
       (i32.const 4)
       (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
       ) (i32.const 4))))) (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4))))))
 (memory.copy
  (i32.add (i32.const 4) (i32.sub (global.get $HP) (i32.add (i32.add
      (i32.const 4)
      (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
      ) (i32.sub (i32.const 4) (i32.rem_s (i32.add
        (i32.const 4)
  ...
  (i32.add (i32.const 4) (i32.load (i32.add (global.get $SP) (i32.const 4))))
  (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4))))
  )
 (memory.copy
  (i32.add
   (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4))))
   (i32.add
    (i32.const 4)
    (i32.sub (global.get $HP) (i32.add (i32.add
       (i32.const 4)
       (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
       ) (i32.sub (i32.const 4) (i32.rem_s (i32.add
         (i32.const 4)
  ...
  (i32.add (i32.const 4) (i32.load (i32.sub (global.get $SP) (i32.const 4))))
  (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4))))
  )
 (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.sub (global.get $HP) (i32.add (i32.add
     (i32.const 4)
     (i32.add (i32.load (i32.load (i32.add (global.get $SP) (i32.const 4)))) (i32.load (i32.load (i32.sub (global.get $SP) (i32.const 4)))))
     ) (i32.sub (i32.const 4) (i32.rem_s (i32.add
       (i32.const 4)
 ...
 (block $whileLoop0 (loop
   ...
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 64))
   (i32.store (global.get $SP) (i32.const 4))
   (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
   (i32.store (global.get $SP) (i32.const 1))
   ...
   (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
   (global.set $SP (i32.add (global.get $SP) (i32.const 16)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.xor (i32.const 1) (call $equals (global.get $SP) (i32.sub (global.get $SP) (i32.const 8))) ))
   (i32.store (global.get $SP) (i32.const 3))
   (global.set $SP (i32.sub (global.get $SP) (i32.const 8)))
   (i32.store (i32.add (i32.const 4) (global.get $SP)) (i32.const 1))
   (i32.store (global.get $SP) (i32.const 1))
